...
var $author$project$Main$decodeKeys = function (keyF) {
	return _Utils_eq(
		...
		$author$project$Lib$WkApp$JustDown) ? $author$project$Main$NewGame : (_Utils_eq(
		keyF($author$project$Lib$WkApp$LeftArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Main$Turn($author$project$Types$Left) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$DownArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Main$Turn($author$project$Types$Down) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$RightArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Main$Turn($author$project$Types$Right) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$UpArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Main$Turn($author$project$Types$Up) : $author$project$Main$None))));
};
		...
		return _Utils_Tuple2(
			...
			function () {
				...
				switch (_v0.$) {
					...
					case 'HitSelf':
						return $author$project$Lib$WkApp$playSound('Sounds/failure.wav');
					case 'HitWall':
						return $author$project$Lib$WkApp$playSound('Sounds/failure.wav');
					default:
...
var $author$project$Main$main = A3(
	...
	$author$project$Lib$WkApp$Every(150),
