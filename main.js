...
var $author$project$Main$initialModel = {direction: $author$project$Main$Right, x: 0, y: -4};
var $author$project$Main$Left = {$: 'Left'};
var $author$project$Main$NewX = function (a) {
	return {$: 'NewX', a: a};
};
...
var $author$project$Main$cmdForRandomX = A2(
	$elm$random$Random$generate,
	$author$project$Main$NewX,
...
var $author$project$Main$jump = function (model) {
	return _Utils_update(
		model,
		{y: model.y + 0.2});
};
var $author$project$Lib$WkApp$playSound = _Platform_outgoingPort('playSound', $elm$json$Json$Encode$string);
var $author$project$Main$playBumpCmd = $author$project$Lib$WkApp$playSound('Sounds/bump.mp3');
var $author$project$Main$playJumpCmd = $author$project$Lib$WkApp$playSound('Sounds/jump.wav');
		...
		switch (msg.$) {
			case 'Tick':
				...
				var _v3 = _Utils_Tuple2(
					$author$project$Main$decodeKeys(keyFunction),
					direction);
				_v3$3:
				while (true) {
					if (_v3.a.$ === 'Just') {
							...
							case 'Space':
								...
								return _Utils_Tuple2(
									$author$project$Main$step(
										$author$project$Main$jump(model)),
									$author$project$Main$playJumpCmd);
							case 'LeftArrow':
								if (_v3.b.$ === 'Right') {
									var _v5 = _v3.a.a;
									var _v6 = _v3.b;
									return _Utils_Tuple2(
										$author$project$Main$step(
											_Utils_update(
												model,
												{direction: $author$project$Main$Left})),
										$author$project$Main$playBumpCmd);
								} else {
									break _v3$3;
								}
							case 'RightArrow':
								if (_v3.b.$ === 'Left') {
									...
									return _Utils_Tuple2(
										$author$project$Main$step(
											_Utils_update(
												model,
												{direction: $author$project$Main$Right})),
										$author$project$Main$playBumpCmd);
								} else {
									break _v3$3;
								}
				...
				return _Utils_Tuple2(
					$author$project$Main$step(model),
					$elm$core$Platform$Cmd$none);
			case 'ResetBtnTap':
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[$author$project$Main$playSuccessCmd, $author$project$Main$cmdForRandomX])));
			case 'JumpBtnTap':
				return _Utils_Tuple2(
					$author$project$Main$step(
						$author$project$Main$jump(model)),
...
var $author$project$Main$BoardTapAt = function (a) {
	return {$: 'BoardTapAt', a: a};
};
var $author$project$Main$JumpBtnTap = {$: 'JumpBtnTap'};
var $author$project$Main$ResetBtnTap = {$: 'ResetBtnTap'};
...
var $author$project$Main$viewBug = F2(
...
var $author$project$Main$view = function (model) {
	var tapSurface = A2(
		...
		$author$project$Main$BoardTapAt,
		A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$move,
			_Utils_Tuple2(0, -1),
			A3(
	...
	var resetButton = A2(
		...
		A2(
			...
			$author$project$Main$ResetBtnTap,
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
	...
	var jumpButton = A2(
		...
		A2(
			$MacCASOutreach$graphicsvg$GraphicSVG$notifyTap,
			$author$project$Main$JumpBtnTap,
			A2(
				$MacCASOutreach$graphicsvg$GraphicSVG$filled,
				$MacCASOutreach$graphicsvg$GraphicSVG$orange,
				$MacCASOutreach$graphicsvg$GraphicSVG$circle(0.5))));
	var bug = A2(
		$author$project$Main$viewBug,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"GraphicSVG.Msg (Lib.WkApp.HiddenMsg Main.Msg)","aliases":{"Lib.WkApp.GetKeyState":{"args":[],"type":"( Lib.WkApp.Keys -> Lib.WkApp.KeyState, ( Basics.Float, Basics.Float ), ( Basics.Float, Basics.Float ) )"}},"unions":{"Lib.WkApp.HiddenMsg":{"args":["userMsg"],"tags":{"UserMsg":["userMsg"],"InitTime":["Time.Posix"],"TickTime":["Time.Posix"],"KeyDown":["Basics.Int"],"KeyUp":["Basics.Int"]}},"GraphicSVG.Msg":{"args":["userMsg"],"tags":{"Graphics":["userMsg"],"WindowResize":["Maybe.Maybe ( Basics.Int, Basics.Int )"],"ReturnPosition":["( Basics.Float, Basics.Float ) -> userMsg","( Basics.Float, Basics.Float )"],"NoOp":[]}},"Main.Msg":{"args":[],"tags":{"Tick":["Basics.Float","Lib.WkApp.GetKeyState"],"BoardTapAt":["( Basics.Float, Basics.Float )"],"ResetBtnTap":[],"JumpBtnTap":[],"NewX":["Basics.Float"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Lib.WkApp.KeyState":{"args":[],"tags":{"JustDown":[],"Down":[],"JustUp":[],"Up":[]}},"Lib.WkApp.Keys":{"args":[],"tags":{"Key":["String.String"],"Backspace":[],"Tab":[],"Enter":[],"Shift":[],"Ctrl":[],"Alt":[],"Caps":[],"LeftArrow":[],"UpArrow":[],"RightArrow":[],"DownArrow":[],"Delete":[],"Space":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));