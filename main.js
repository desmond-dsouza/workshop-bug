...
var $author$project$Grid$grid = {cellSize: 20.0, numColumns: 14, numRows: 14};
				...
				switch (_v0.$) {
					case 'Eating':
						return $elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									$author$project$Food$randomFoodCmd,
									$author$project$Main$playSound('Sounds/success.wav')
								]));
					case 'HitSelf':
						return $author$project$Main$playSound('Sounds/failure.wav');
					case 'HitWall':
						return $author$project$Main$playSound('Sounds/failure.wav');
					default:
...
var $author$project$Types$Turn = function (a) {
	return {$: 'Turn', a: a};
};
var $author$project$Main$userRequest = function (keyF) {
	return _Utils_eq(
		keyF($author$project$Lib$WkApp$Space),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Types$NewGame : (_Utils_eq(
		keyF($author$project$Lib$WkApp$LeftArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Types$Turn($author$project$Types$Left) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$DownArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Types$Turn($author$project$Types$Down) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$RightArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Types$Turn($author$project$Types$Right) : (_Utils_eq(
		keyF($author$project$Lib$WkApp$UpArrow),
		$author$project$Lib$WkApp$JustDown) ? $author$project$Types$Turn($author$project$Types$Up) : $author$project$Types$None))));
};
							...
							if (_v2.b.$ === 'Turn') {
								...
								return A2(
									...
									_Utils_update(
										model,
										{
											snake: A2($author$project$Snake$turn, direction, snake)
										}));
							} else {
